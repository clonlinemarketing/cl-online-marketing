      ...
      <section className="py-20 md:py-28 px-6 overflow-hidden" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={staggerContainer} {...safeAnimAnimate(staggerContainer, shouldReduce)}>
            <motion.div variants={fadeUp}><Eyebrow>Google Ads</Eyebrow></motion.div>
            ...
            <motion.p className="text-lg mb-8" style={{ color: '#4A5568' }} variants={fadeUp}>Google Ads puts your business at the top of search results for high-intent keywords — reaching customers the moment they're actively searching for what you offer. Immediate visibility. Measurable ROI.</motion.p>
      ...
      <section className="py-16 px-6" style={{ background: '#F5F7FA' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            ...
            <p style={{ color: '#4A5568', lineHeight: 1.8 }}>Unlike social media ads that interrupt, Google Ads captures demand — you appear when a potential customer types exactly what they need. This intent-based targeting makes Google Ads one of the highest-ROI paid channels available to businesses.</p>
          </motion.div>
