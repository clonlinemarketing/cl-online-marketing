    ...
    <>
      ...
      <section className="py-20 md:py-28 px-6 overflow-hidden" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={staggerContainer} {...safeAnimAnimate(staggerContainer, shouldReduce)}>
            <motion.div variants={fadeUp}><Eyebrow>eCommerce Website</Eyebrow></motion.div>
            ...
            <motion.p className="text-lg mb-8" style={{ color: '#4A5568' }} variants={fadeUp}>A fully equipped online store for businesses — product pages, secure checkout, payment gateway, order management, and everything your customers expect from a trustworthy online shopping experience.</motion.p>
      ...
      <section className="py-16 px-6" style={{ background: '#F5F7FA' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            ...
            <p style={{ color: '#4A5568', lineHeight: 1.8 }}>Consumers increasingly shop online — from product discovery to checkout. An eCommerce website lets your business sell around the clock, reach customers beyond your physical location, and scale without the constraints of a physical shopfront.</p>
          </motion.div>
      ...
      <section className="py-20 px-6" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-6" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            {[{ icon: ShoppingCart, title: 'Product Catalogue & Management', body: 'Clean product listings with images, descriptions, variants, and inventory management built in.' }, { icon: CreditCard, title: 'Secure Payment Gateway', body: 'Payment methods supported — credit/debit cards, FPX, e-wallets, and more.' }, { icon: Package, title: 'Order & Shipping Management', body: 'Order tracking, shipping integration, and fulfilment workflows to manage your business efficiently.' }, { icon: Search, title: 'eCommerce SEO', body: 'Product pages and category pages optimised for Google so your store gets found organically.' }, { icon: Lock, title: 'Secure & SSL-Certified', body: 'Full HTTPS security — essential for customer trust and Google ranking.' }, { icon: Zap, title: 'Fast & Mobile-Optimised', body: 'Speed-optimised for mobile shoppers — slow load times kill conversions on mobile.' }].map((t) => (<motion.div key={t.title} variants={fadeUp}><TrustCard {...t} /></motion.div>))}
          </motion.div>
        </div>
      </section>
      {/* FAQ */}
      <section className="py-20 px-6" style={{ background: '#F5F7FA' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <FAQAccordion items={[{ q: 'Which payment gateways do you support for eCommerce?', a: 'We integrate with major payment gateways supporting FPX, credit/debit cards, and popular e-wallets — so your customers can pay however they prefer.' }, { q: 'Can I manage my own products and inventory after launch?', a: 'Yes. We build on platforms with intuitive admin dashboards so you can add products, update stock, and manage orders without any technical knowledge.' }, { q: 'How long does it take to build an eCommerce website?', a: 'Typically 6–10 weeks depending on the number of products, payment integration complexity, and content readiness.' }]} />
        </div>
      </section>
