    ...
    <>
      ...
      <section className="py-20 md:py-28 px-6 overflow-hidden" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={staggerContainer} {...safeAnimAnimate(staggerContainer, shouldReduce)}>
            <motion.div variants={fadeUp}><Eyebrow>Website Design & Development</Eyebrow></motion.div>
            ...
            <motion.p className="text-lg mb-8" style={{ color: '#4A5568' }} variants={fadeUp}>We design and build professional websites for business owners, SMEs, startups, and enterprises — custom-designed, mobile-first, SEO-ready, and built to drive real business results.</motion.p>
      ...
      <section className="py-16 px-6" style={{ background: '#F5F7FA' }}>
        <div className="max-w-4xl mx-auto">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            <h2 className="mb-5">A Poor Website Doesn't Just<br />Look Bad — It Will Drop Your Revenue.</h2>
            <p style={{ color: '#4A5568', lineHeight: 1.8 }}>In today's digital-first market, your website is your first impression. A slow, outdated, or poorly structured site sends visitors straight to your competitors — and most leave within 3 seconds.</p>
          </motion.div>
        </div>
      </section>
      {/* CARDS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            {[
              ...
              { icon: ShoppingCart,  title: 'eCommerce Website',              body: 'A fully equipped online store — product pages, secure checkout, payment gateway, and everything your customers expect.',               to: '/services/web-design/ecommerce' },
              { icon: GraduationCap, title: 'LMS Website',                   body: 'Course catalogue, student portal, payment and enrollment — a complete learning management system for your educators and coaches.',           to: '/services/web-design/lms' },
      ...
      <section className="py-20 px-6" style={{ background: '#F5F7FA' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-4" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
            {[{ icon: Palette, label: 'Custom Design' }, { icon: Smartphone, label: 'Mobile-First Responsive' }, { icon: Search, label: 'SEO-Ready on Launch' }, { icon: Lock, label: 'SSL & Security' }, { icon: Zap, label: 'Speed Optimised' }, { icon: Edit, label: 'Easy Content Management' }].map(({ icon: Icon, label }) => (
      ...
      <section className="py-20 px-6" style={{ background: '#FFFFFF' }}>
        <div className="max-w-7xl mx-auto">
          ...
          <ProcessSteps steps={[{ title: 'Discovery', body: 'We learn about your business, goals, audience, and competitors.' }, { title: 'Strategy & Sitemap', body: 'We plan the structure, user flows, and content strategy.' }, { title: 'Design & Approval', body: 'We design your website and get your sign-off before development.' }, { title: 'Development', body: 'We build the site clean, fast, and fully mobile-responsive.' }, { title: 'Testing', body: 'We test across devices and browsers before anything goes live.' }, { title: 'Launch & Handover', body: 'We launch your site and walk you through how to manage it.' }]} />
        </div>
      </section>
      {/* WHY */}
      <section className="py-20 px-6" style={{ background: '#F5F7FA' }}>
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-12" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}><Eyebrow>Why CL Online Marketing Agency</Eyebrow><h2 className="mt-3">Why Choose CL Online Marketing Agency for Your Website.</h2></motion.div>
